...
public class Generators {
    ...
    public static void createCassandraStressTables(Session session, OptionSet options) {
        try {
    ...
    public static final QueryGenerator.Builder CASSANDRA_INSERTER = new QueryGenerator.Builder() {
        public QueryGenerator create(final int id, final int iterations, final OptionSet options,
    ...
    public static final QueryGenerator.Builder CASSANDRA_PREPARED_INSERTER =
            new QueryGenerator.Builder() {
        public QueryGenerator create(final int id, final int iterations, final OptionSet options,
                                     final Session session) {
